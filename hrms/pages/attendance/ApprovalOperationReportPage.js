...
/**
 * /approval-operation-report — post-approval register of worked-day records
 * (HRMS breadcrumb generation). Card "Approval Operation Report".
 * Grid: SL No | IDNumber | Employee Name | Date | Entry Time | Exit Time |
 * Balance Hours | Fixed Hours | Fixed Date | Discount from Permission Hours |
 * Remarks | Final Hours | Details | Delete.
 * Per-row "Details" opens a drill-down; "Delete" REVERSES an approval (with a
 * confirm dialog) — both are mutation/drill points never clicked by
 * interaction tests. Captured rowCount 0 — data appears only after the
 * "Filter" dialog is applied.
 */
class ApprovalOperationReportPage extends BasePage {
  /** @param {import('@playwright/test').Page} page */
  constructor(page) {
    super(page, 'approval-operation-report');
...
module.exports = { ApprovalOperationReportPage };
