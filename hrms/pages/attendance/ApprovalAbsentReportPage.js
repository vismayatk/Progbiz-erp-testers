...
/**
 * /approval-absent-report — post-approval register of absent-day records
 * (HRMS breadcrumb generation). Card "Approval Absent Report".
 * Grid: SL No | IDNumber | Employee Name | Date | Period Name | Start Time |
 * End Time | Balance Hours | Fixed Hours | Fixed Date | Remarks | Final Hours |
 * Details | Delete. Mirrors /approval-operation-report structurally — the
 * differing columns are Period Name/Start Time/End Time here vs Entry
 * Time/Exit Time/Discount from Permission Hours there.
 * "Delete" REVERSES an approval (confirm dialog) — never clicked by
 * interaction tests. Captured rowCount 0 — data appears only after the
 * "Filter" dialog is applied.
 */
class ApprovalAbsentReportPage extends BasePage {
  /** @param {import('@playwright/test').Page} page */
  constructor(page) {
    super(page, 'approval-absent-report');
...
module.exports = { ApprovalAbsentReportPage };
