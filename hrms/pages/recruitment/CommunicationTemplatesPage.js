...
/**
 * Communication Templates (/communication-templates) — "Candidate Communication".
 * Reusable candidate messages (name, type, subject) consumed across the
 * application/interview/offer flows.
 *
 * Grid: Sl.No | Name | Type | Subject | Action. The grid initially renders a
 * "Loading..." row (async fetch) — wait it out before asserting data.
 */
class CommunicationTemplatesPage extends BasePage {
  /** @param {import('@playwright/test').Page} page */
  constructor(page) {
    super(page, 'communication-templates');
  ...
  /** Open the create-template form via "New Template". Nothing is saved. */
...
module.exports = { CommunicationTemplatesPage };
